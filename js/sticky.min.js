...
var Sticky = function() {
    ...
    return _createClass(t, [{
        ...
        value: function(t) {
            ...
            this.setPosition(t),
            this.stickyScroll = this.setProgress()
        }
    }, {
        ...
        value: function() {
            ...
            this.forEach(this.elements, function(i) {
                t.destroyResizeEvents(i),
                t.destroyScrollEvents(i),
                delete i.sticky
            })
        }
    }, {
            ...
            function t(t) {
                ...
                this.getProgress = function() {
                    var t = $(window).scrollTop()
                      , i = t - this.startTop;
                    return this.progress = (i / this.distance).toFixed(2),
                ...
                this.getPara = function() {
                    ...
                    this.startTop = i.sticky.rect.top - i.sticky.marginTop,
                    this.distance = e.offsetHeight - i.sticky.rect.height
                }
                ,
                this.init()
            }
